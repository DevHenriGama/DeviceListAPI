...
begin
  ...
  with Device.GetListRequests do
  begin
    for I := 0 to Count - 1 do
    begin
...
begin
  with Device do
  begin
    lblTotalRequestValue.Text := IntToStr(RequestCount);
    lblTotalDevicesValue.Text := IntToStr(NumDevices);
    lblRequestTodayValue.Text := IntToStr(GetRequestToday);
  end;
end;
